...
export const Controls: FC<ControlProps> = ({ controls, show }) => <>
    <aside id="logo-sidebar"
           className={`h - [calc(100vh - 72px)] hidden sm:block w-${ControlW} transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
           aria-label="Sidebar">
        <div className="hidden sm:block h-0 sm:h-full px-0.5 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
